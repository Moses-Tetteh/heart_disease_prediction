...
const PneumoniaPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/api/v1/predict/pneumonia-pred",
        formDataToSend,
        {
          headers: {
  ...
  return (
    <div className="stroke-container">
      <h1 className="stroke-header">Pneumonia Detection Analysis</h1>
          ...
          <div className="stroke-upload-section">
            <div className="stroke-upload-box">
              <label className={imageUploaded ? "uploaded" : ""}>
                ...
                {imageUploaded ? "Scan Uploaded" : "Upload Pneumonia Scan image"}
                <input
                  type="file"
                  accept=".jpg,.jpeg,.png"
